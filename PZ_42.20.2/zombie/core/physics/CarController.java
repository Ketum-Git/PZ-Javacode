...
public final class CarController {
    ...
    private void control_Forward(float speed) {
        ...
        if (trainFastDriver) {
            if (speed < 50.0F) {
                this.vehicleObject.addEngineSpeed(-Math.min(0.06 * (this.vehicleObject.getEngineSpeed() - 7000.0), (double)(30.0F - speed)) * fpsMult);
            }
        } else if (speed < 30.0F) {
            this.vehicleObject.addEngineSpeed(-Math.min(0.02 * (this.vehicleObject.getEngineSpeed() - 7000.0), (double)(30.0F - speed)) * fpsMult);
        }
    ...
    private void control_ForwardNew(float speed) {
        ...
        if (this.vehicleObject.transmissionNumber.getIndex() < gearRatioCount && this.vehicleObject.transmissionNumber.getIndex() - 1 >= 0) {
            this.vehicleObject
                .setEngineSpeed(
                    Math.min(
                        this.vehicleObject.getEngineSpeed(), (double)(carRpmData[this.vehicleObject.transmissionNumber.getIndex() - 1].gearChange + 100.0F)
                    )
                );
        }
