        ...
        if (!Core.getInstance().isNoSave()) {
            ...
            if (!path.exists()) {
                ...
                try {
                    ...
                    DebugType.General.printException(var8, LogSeverity.Error, "Error loading WorldDictionary.");
        ...
        if (!Core.getInstance().isNoSave()) {
            ...
            if (path.exists() && path.isDirectory()) {
                ...
                try (FileWriter w = new FileWriter(f, false)) {
                    ...
                    DebugType.General.printException(var10, LogSeverity.Error, "Error saving WorldDictionary as text.");
