            ...
            switch (this.type) {
                ...
                case RemoveAndGrabAnimalFromTrailer:
                    if (this.animalId.isConsistent(connection)
                        ...
                        InventoryItem var14 = this.item;
                        if (var14 instanceof InventoryItem) {
                            this.playerId.getPlayer().getInventory().AddItem(var14);
                            this.playerId.getPlayer().setPrimaryHandItem(var14);
                            this.playerId.getPlayer().setSecondaryHandItem(var14);
                            this.animalId.getAnimal().itemId = this.item.id;
                            if (var14 instanceof AnimalInventoryItem animalItem) {
                ...
                case FeedAnimalFromHand:
                    if (this.animalId.isConsistent(connection) && this.playerId.isConsistent(connection)) {
                        InventoryItem var20 = this.item;
                        if (var20 instanceof InventoryItem) {
                            this.animalId.getAnimal().feedFromHand(this.playerId.getPlayer(), var20);
                        } else {
                ...
                case HutchGrabCorpseAction:
                    if (this.animalId.isConsistent(connection) && this.playerId.isConsistent(connection) && this.objectId.isConsistent(connection)) {
                        InventoryItem var18 = this.item;
                        if (var18 instanceof InventoryItem) {
