...
public final class Nutrition {
        ...
        if (!GameClient.client) {
            if (SandboxOptions.instance.nutrition.getValue()) {
                if (this.parent != null && !this.parent.isDead()) {
                    if (!GameClient.client || this.parent.isLocalPlayer()) {
    ...
    private void updateWeight() {
        ...
        if (this.getCalories() > caloriesToGainWeight) {
            ...
            this.setWeight(this.getWeight() + realWeightGain * delta * GameTime.getInstance().getGameWorldSecondsSinceLastUpdate());
            ...
            this.setWeight(this.getWeight() - 8.5E-6F * deltax * GameTime.getInstance().getGameWorldSecondsSinceLastUpdate());
        }
