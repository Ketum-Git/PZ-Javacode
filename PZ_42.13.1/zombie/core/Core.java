...
public final class Core {
    ...
    public String getGitSha() {
        if (this.gitSha == null) {
            this.gitSha = IS_DEV ? DevMainScreenState.getDevSha() : "1267173a2044ba62aa3d0a0e9899b15e9057de5c";
        }
    ...
    public String getGitRevision() {
        if (this.gitRevisionString == null) {
            if (IS_DEV) {
                ...
                this.gitRevisionString = "1267173a2044ba62aa3d0a0e9899b15e9057de5c"
                    .substring(0, Math.min("1267173a2044ba62aa3d0a0e9899b15e9057de5c".length(), 20));
            }
        }
    ...
    public static String getGitRevisionString() {
        return IS_DEV ? core.getGitRevision() : "1267173a2044ba62aa3d0a0e9899b15e9057de5c 2025-12-18 10:34:47 (ZB)";
    }
