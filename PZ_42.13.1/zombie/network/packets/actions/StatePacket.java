...
public class StatePacket extends Position implements INetworkPacket {
    ...
    public void processServer(PacketTypes.PacketType packetType, UdpConnection connection) {
        if (State.Stage.Exit == this.stage) {
            ...
            if (this.isSubState) {
                StatePacket exitSubStatePacket = this.characterId.getCharacter().getNetworkCharacterAI().getState().getExitSubState();
                if (exitSubStatePacket != null) {
                    this.characterId.getCharacter().getNetworkCharacterAI().getState().removeExitSubState(exitSubStatePacket);
                }
                ...
                StatePacket exitStatePacket = this.characterId.getCharacter().getNetworkCharacterAI().getState().getExitState();
                if (exitStatePacket != null) {
                    this.characterId.getCharacter().getNetworkCharacterAI().getState().removeExitState(exitStatePacket);
                }
