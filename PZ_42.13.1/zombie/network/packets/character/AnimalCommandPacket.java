...
public class AnimalCommandPacket implements INetworkPacket {
    ...
    public void setData(Object... values) {
        ...
        } else if (values.length == 5 && values[1] instanceof IsoAnimal animal && values[2] instanceof IsoPlayer player) {
            this.set((AnimalCommandPacket.Type)values[0], animal, player, (IsoObject)values[3], (Boolean)values[4]);
        } else {
