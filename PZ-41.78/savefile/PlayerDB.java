...
public final class PlayerDB {
   ...
   private PlayerData allocPlayerData() {
      PlayerData var1 = (PlayerData)this.m_fromThread.poll();
      if (var1 == null) {
         var1 = new PlayerData();
      }
   ...
   public void updateWorldStreamer() {
      for(PlayerData var1 = (PlayerData)this.m_toThread.poll(); var1 != null; var1 = (PlayerData)this.m_toThread.poll()) {
         try {
   ...
   private static final class PlayerData {
      ...
      PlayerData set(IsoPlayer var1) throws IOException {
         assert var1.sqlID >= 1;
