        ...
        if (!GameClient.client || this.player.getPlayer() != null) {
            if (GameClient.client) {
                ...
                if (primaryHand == EquipPacket.HandStatus.Nothing) {
                    ...
                    try {
                        primaryHandItem = InventoryItem.loadItem(b, 241);
                        ...
                        if (hasVisual == 1) {
                            primaryHandItem.getVisual().load(b, 241);
                        }
                ...
                if (secondaryHand == EquipPacket.HandStatus.Nothing) {
                    ...
                    try {
                        secondaryHandItem = InventoryItem.loadItem(b, 241);
                        if (this.player.getPlayer().isLocalPlayer()) {
                        ...
                        byte hasVisual = b.get();
                        if (hasVisual == 1) {
                            secondaryHandItem.getVisual().load(b, 241);
                        }
