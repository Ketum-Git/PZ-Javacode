...
public class ItemStatsPacket implements INetworkPacket {
    ...
    public void write(ByteBufferWriter b) {
        ...
        if (this.isFood) {
            ...
            b.putShort((short)this.extraItems.size());
            ...
            b.putUTF(this.name);
            b.putShort((short)this.spices.size());
    ...
    public void parse(ByteBuffer b, UdpConnection connection) {
        ...
        if (this.isFluidContainer) {
            try {
                this.fluidContainer.load(b, 241);
        ...
        if (this.isFood) {
            ...
            this.extraItems.clear();
            short extraItemsSize = b.getShort();
            ...
            this.spices.clear();
            short spicesSize = b.getShort();

            for (int i = 0; i < spicesSize; i++) {
                this.spices.add(GameWindow.ReadString(b));
            }
        }
    }
